...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".document",
     ...
     "lib/apple_push_notification/notification.rb",
     "lib/apple_push_notification/notification_job.rb",
     "lib/apple_push_notification/queue_manager.rb",
     "lib/apple_push_notification/sender.rb",
     "lib/apple_push_notification/sender_daemon.rb",
     "lib/apple_push_notification/tasks.rb",
